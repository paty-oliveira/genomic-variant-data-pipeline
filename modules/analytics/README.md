...
Athena reads the Iceberg tables written by the processing module directly from S3, using the Glue Data Catalog as the metastore. Query results are stored in a dedicated S3 bucket.
...
Configure `dbt-athena-community` to use this workgroup:
